...
```bash
sudo dpkg -i dist/openmediavault-agent_1.7.2_all.deb
...
`1.7.2` - Ollama integration fix, nginx timeout increase, system_report probe, and optimized routing to skip Ollama for live probe queries.
